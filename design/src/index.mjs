...
const Stede = new Design({
  ...
  parts: [ body, sleeve, underarmGusset, shoulderPieces, neckGusset, collar, slitGusset, cuff ],
})
...
export { body, sleeve, underarmGusset, shoulderPieces, neckGusset, collar, slitGusset, cuff, Stede, Pattern }
